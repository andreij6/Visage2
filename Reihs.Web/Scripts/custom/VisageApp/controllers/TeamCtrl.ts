	...
	export class TeamCtrl {
		...
		BuildStaffers(): any {
			...
			var RachelG = new Staffer(
				'Medical Assitant',
				'I am the Physicians Coordinator at Le Beau Visage.  I’m an Orange County girl, raised in Saudi Arabia, and settled in Texas.  I am currently attending Collin County Community College and later plan to earn a Bachelor of Science in Nursing from the University of North Texas.  My patients are my favorite part of my day.  When I’m not working, I love traveling, crafting, and being outdoors.  If you ever need a sushi date or a meaty steak, I’m your girl!',
				false,
				'Rachel', 'Gonzalez', 5
				);
