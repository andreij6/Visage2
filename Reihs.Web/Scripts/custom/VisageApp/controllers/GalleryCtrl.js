...
(function (VisageApp) {
    var GalleryCtrl = (function () {
        function GalleryCtrl($scope, $location) {
            ...
            function getProcedure(procedureCode) {
                var result = "";
                if (procedureCode === 1) {
                    result = "Botox";
                }
            ...
            function addProcedure(procedureCode) {
                var result = "";
                if (procedureCode === 1) {
            ...
            function setimg(imageName, procedureCode) {
        ...
        GalleryCtrl.prototype.init = function () {
            var self = this;
            //check the query String
        };
        return GalleryCtrl;
    })();
    VisageApp.GalleryCtrl = GalleryCtrl;

    GalleryCtrl.$inject = ['$scope', '$location'];
})(VisageApp || (VisageApp = {}));
//# sourceMappingURL=GalleryCtrl.js.map
