	...
	export class TestimonialCtrl {
		...
		constructor(
			...
			var brad = new Client(
				...
				"Because of his tireless commitment to health and fitness, he places a lot of pride on maintaining those aspects of his life, including his outward appearance.Brad really sought services to improve some of the wrinkles around his eyes and the sunspots that had developed from chronic sun exposure.",
				"Brad really observed some significant changes in the pigmentation after even a single photofacial over three years ago.   “Between the consistent treatment with Botox and photofacials, my skin has really improved and, beyond my own observations, I  now get comments on the quality of my skin,” says Brad.  “Thanks for being a good friend and taking such good care of us.”",
				''
				);
			...
			var kim = new Client(
				...
				"Kim is an accomplished woman who loves the outdoor and family activities; she wanted to find an aesthetic center that would help maintain her youthful appearance through non-surgical avenues.She has undergone a number of procedures including Botox, Scupltra,and Microdermabrasion.",
				"The Sculptra has really helped improve the hollowing in her mid-face and temples.  “The whole experience has been wonderful, from the atmosphere, to the awesome staff, to the results.”",
				"“If you are contemplating calling Le Beau – Do it!”"
			);

			var michelle = new Client(
				"Michelle",
				46,
				false,
				true,
				...
				"“When I met Dr. Riehs, I just felt reassured that I was in the right place. Dr. Riehs is dynamic, comforting and real.He was able to give me realistic expectation about the procedures I was considering…Im so glad I made that first appointment.”",
				"Since her first appointment almost five years ago, Michelle has been treated with Fraxel, Photofacials and Restylane.She is overwhelmed with her skin.  “I have the best skin I have ever had.”",
				""
			);

			var iliana = new Client(
				"Iliana",
				43,
				false,
				true,
			...
			var shirley = new Client(
				...
				"She has received a number of treatments ranging from Botox to Restylane and most recently, a skin - tightening laser, FORMA, for her neck and jaw line.Shirley has responded remarkably to the laser and is extremely pleased with her results.",
				'“Dr. Riehs and his staff are always very caring.  All of my expectations were met and more.”',
				''
			);
			...
			var debbie = new Client(
				...
				'Debbie did her homework and had reviewed the internet to ensure the credibility of Dr. Riehs and Le Beau Visage Aesthetic Center.  She ultimately decided to get a complimentary',
				'',
				''
			);

			var angela = new Client(
				"Angela",
				38,
				false,
				true,
				...
				'She has been receiving microdermabrasions for several years and really loves the microdermabrasion program offered at Le Beau Visage, which allows for consistent monthly treatments at a minimum cost.',
				'“I love this office…while the office is extremely profession, they also are like a family. I love coming for my monthly microdermabrasion.”',
				''
			);

			var nancy = new Client(
				"Nancy",
				52,
				false,
				true,
			...
			var chad = new Client(
				...
				'Chad laughes, “The real reason I came to see you occurred after I saw a photograph of my eyes; I thought, ‘Wow, they are really wrinkled and it’s time.’”',
				'Over the years, Chad has maintained his consistency with Botox but has also ventured into the filler arena, which surprisingly, has been the most compelling treatment thus far. “I never realized how much filler could really soften my appearance and help me look more youthful.”  Chad has never regretted stepping out of his comfort zone and using Juvederm.',
				'“Without a doubt, the Botox and Juvederm treatments are the easiest thing I do that have the biggest effect…and I recommend Le Beau Visage to everyone!”'
				);

			var fernando = new Client(
				"Fernando",
				54,
				false,
				true,
				...
				'Since beginning his microdermabrasion treatments in late 2005, Fernando has seen a tremendous change in the texture and quality of his skin.He is a big proponent of Skin Medica, particularly the TNS Essential Serum.',
				'“My skin looks better now that I am 54 than it did when I was 40.  The products provided and every single treatment that I have had done make me feel great. I feel 40!”',
				''
			);
			...
			var peggy = new Client(
				...
				'However, Peggy was particularly worried about getting filler,  especially since there are so many injectors in the area.Integrity is a one of the key components in finding the right cosmetic facility.',
				'After reviewing Dr. Riehs’ credentials and speaking with him directly, she felt comfortable moving forward with Dr.Riehs as her cosmetic injector.  “He’ll tell me what I need and also what I don’t need, which is sometimes the most important part.”',
				'Despite being very anxious about having filler placed under her eyes, she could not be more thrilled with the procedure.  “The tear trough really made all the difference!”'
			);

			var isabel = new Client(
				"Isabel",
				55,
				false,
				false,
			...
			var brandi = new Client(
				...
				'Initially, Brandi started with microdermabrasion and then moved onto photofacials and Botox.  “These treatments have made a tremendous difference in my skin and how I feel about myself.”',
				'',
				''
			);

			var tamme = new Client(
				"Tamme",
				51,
				false,
				true,
				...
				'After initial treatments with Botox and Dysport around her eyes, she was interested in something more aggressive to treat the crêpe skin under the eyes.  She considers laser treatments but was not without concerns.',
				'She received the Fractora skin resurfacing and firming and was sold!   Tamme feels that the treatments have really changed her eye texture!',
				'“I am definitely doing this again,” says Tamme.  “I have trusted Dr. Riehs for years and love my results.”'
			);

			var marlene = new Client(
				 "Marlene",
				60,
				false,
				true,
				...
				'“I originally came to the office because I wanted to look younger and fresher.  I have done a number of services from Botox to Restylane, but I think my favorite is the Sculptra.I love what it did to my cheeks and how it helped lift my face.”',
				'While Marlene loves the immediate effect of some of the fillers like Restylane and Perlane, she has fallen in love with the slow changes that have occurred with non-traditional fillers, Sculptra.The product has been able to reposition her fallen lateral cheeks and provide a lift throughout the entire face. “I have been going to Dr.Riehs for the past 7 years and have no intention of leaving.He has taken years off my aging face…or at least kept my face on ice,” says Marlene, with a smile.',
				''
			);
